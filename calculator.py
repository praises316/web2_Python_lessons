...
print(f"The result of the subtraction from the two numbers is equal to {sub}")
...
print(f"The result of the multiplication from the two numbers is equal to {Multiplication}")
...
print(f"The result of the division from the two numbers is equal to {Division}")
...
print(f"The result of the exponential from the two numbers is equal to {Exponential}")
